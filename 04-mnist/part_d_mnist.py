...
class Model(torch.nn.Module):
    def __init__(self, num_steps=1000, embed_dim=16):
        ...
        self.conv_in = torch.nn.Conv2d(1, 8, 1)
        self.enc1 = ConvBlock(8, 16, embed_dim)
        ...
        self.conv_out = torch.nn.Conv2d(16, 1, kernel_size=1)
    ...
    def forward(self, x, t):
        ...
        out = torch.nn.functional.relu(self.norm_out(dec1))
